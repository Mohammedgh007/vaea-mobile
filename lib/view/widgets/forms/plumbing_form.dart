...
import 'package:vaea_mobile/view/formatters/plumbing_issue_category_formatter.dart';
...
/// It builds, validates, and manages the plumbing form in SubmitServiceLayout.
class PlumbingForm extends StatefulWidget {
  ...
  PlumbingForm({
    ...
    required this.handleSubmitPlumbingForm
  });
...
class _PlumbingFormState extends State<PlumbingForm> {
  ...
  Widget buildRoomField() {
    return VAEADropdownField<RoomNameEnum>(
      ...
      options: RoomNameFormatter.getPlumbingRoomsList(context),
      optionsValues: RoomNameFormatter.getPlumbingRoomsVal(),
  ...
  Widget buildCategoryField() {
    return VAEADropdownField<PlumbingIssueCategoryEnum>(
      breakpoint: widget.breakpoint,
      layoutConstraints: widget.layoutConstraints,
      ...
      options: PlumbingIssueCategoryFormatter.getCategoriesList(context, selectedRoom!),
      optionsValues: PlumbingIssueCategoryFormatter.getCategoriesVal(selectedRoom!),
  ...
  void handleSubmit() {
    ...
    if (isValid) {
      widget.handleSubmitPlumbingForm(
